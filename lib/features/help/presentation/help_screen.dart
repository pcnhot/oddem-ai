...
class HelpScreen extends StatelessWidget {
  ...
  static const _faqs = <_Faq>[
    ...
    _Faq('ما هو الوضع الصارم (StrictMode)؟',
        'يتيح لك تغيير عنصر واحد فقط داخل صورة الغرفة مع الإبقاء على بقية العناصر كما هي تمامًا.'),
    _Faq('متى يتم تركيب الأثاث؟',
        'يظهر تقدير التركيب عند إتمام الطلب فقط، ويعتمد على مدينتك وتوفّر المورّد. التقدير تقريبي وليس وعدًا ثابتًا.'),
    _Faq('هل المنتجات أصلية؟',
        'نعم، جميع المنتجات من موردين سعوديين، وتتضمن تفاصيل المقاسات والخامات والألوان والمخزون.'),
    _Faq('ما هي معاينة الواقع المعزز (AR)؟',
        'تتيح لك معاينة القطعة بالحجم الحقيقي داخل غرفتك قبل الشراء (قيد التطوير ضمن النسخة الأولى).'),
  ];
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text('تواصل معنا: support@oddem.sa',
